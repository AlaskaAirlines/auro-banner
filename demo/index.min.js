...
class AuroBanner extends r {
  ...
  static register(name = "auro-banner") {
    AuroLibraryRuntimeUtils$1.prototype.registerComponent(name, AuroBanner);
  }
    ...
    return u`
      ...
      ${this.iconic
        ...
        <div class="iconContainer">
          <div class="roundIconBg" style="background: ${o(!this.iconbg ? undefined : this.iconbg)}">
